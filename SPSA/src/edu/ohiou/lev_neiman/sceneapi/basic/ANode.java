...
public class ANode
{
   ...
   public boolean show = true;
    ...
    public void render( GLAutoDrawable g )
    {
        ...
        gl.glRotated( rotation_angle, rotation.getX(), rotation.getY(),
                      rotation.getZ() ); // rotate around rotation by rotation_angle
    ...
    static public void renderTree( GLAutoDrawable contex, ANode root )
    {
        ...
        if( root.pushPop() )
        {
            gl.glPopMatrix(); // // pop current model view matrix from the stack, if pushPop is true
        }
    }
     ...
     * @return Coordinate
     */
    public static Coordinate getNormal( Coordinate a, Coordinate b,
                                        Coordinate c )
    {
        ...
        /*
                 double i = ((( b.getY() - a.getY() ) * ( c.getZ() - a.getZ() ) ) - ( ( c.getY() - a.getY() ) * ( b.getZ() - a.getZ() ) ) );
                 double j = ((( b.getZ() - a.getZ() ) * ( c.getX() - a.getX() ) ) - ( ( c.getZ() - a.getZ() ) * ( b.getX() - a.getX() ) ) );
                 double k = ((( b.getX() - a.getX() ) * ( c.getY() - a.getY() ) ) - ( ( c.getX() - a.getX() ) * ( b.getY() - a.getY() ) ) );
         */
        tmp.setX( i );
        tmp.setY( -1 * j );
        tmp.setZ( k );
