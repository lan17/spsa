...
public class MaterialGroupNode extends ANode
{
	 ...
	 * 
	 * @param mtl_group
	 *            Vector - triangles that belong to this group.
	 */
	...
	public Coordinate getCenter()
	{
		...
		{
			if (xMax < triangle.a.getX())
			{
				xMax = triangle.a.getX();
			}
			if (yMax < triangle.a.getY())
			{
				yMax = triangle.a.getY();
			}
			if (zMax < triangle.a.getZ())
			{
				zMax = triangle.a.getZ();
			}
			if (xMin > triangle.a.getX())
			{
				xMin = triangle.a.getX();
			}
			if (yMin > triangle.a.getY())
			{
				yMin = triangle.a.getY();
			}
			if (zMin > triangle.a.getZ())
			{
				zMin = triangle.a.getZ();
			}

			if (xMax < triangle.b.getX())
			{
				xMax = triangle.b.getX();
			}
			if (yMax < triangle.b.getY())
			{
				yMax = triangle.b.getY();
			}
			if (zMax < triangle.b.getZ())
			{
				zMax = triangle.b.getZ();
			}
			if (xMin > triangle.b.getX())
			{
				xMin = triangle.b.getX();
			}
			if (yMin > triangle.b.getY())
			{
				yMin = triangle.b.getY();
			}
			if (zMin > triangle.b.getZ())
			{
				zMin = triangle.b.getZ();
			}

			if (xMax < triangle.c.getX())
			{
				xMax = triangle.c.getX();
			}
			if (yMax < triangle.c.getY())
			{
				yMax = triangle.c.getY();
			}
			if (zMax < triangle.c.getZ())
			{
				zMax = triangle.c.getZ();
			}
			if (xMin > triangle.c.getX())
			{
				xMin = triangle.c.getX();
			}
			if (yMin > triangle.c.getY())
			{
				yMin = triangle.c.getY();
			}
			if (zMin > triangle.c.getZ())
			{
				zMin = triangle.c.getZ();
			}
	...
	/**
	 * Overloaded render method. This method actually renders the material
	 * group, and maps the texture, applies material properties, etc.
	 * 
	 * @param gld
	 *            GLAutoDrawable
	 */
	...
	{
		super.render( gl ); // call super method, so that spacial information is
							// applied.
		// GL gl = gld.getGL();
		...
		if (faces.get( 0 ).material.texture != null)
		{
			for (Triangle triangle : faces)
			{
				...
				gl.glNormal3d( triangle.normal.getX(), triangle.normal.getY(), triangle.normal.getZ() );
