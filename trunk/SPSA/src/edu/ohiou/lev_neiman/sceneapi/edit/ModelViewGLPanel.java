 ...
 * @version 1.0
 */
public class ModelViewGLPanel
        extends JPanel implements GLEventListener
{
    ...
    public void displayChanged( GLAutoDrawable panel, boolean _boolean,
                                boolean _boolean2 )
    {
    ...
    public void reshape( GLAutoDrawable panel, int x, int y, int width,
                         int height )
    {
        setUpProjection( panel );
        display( panel );
