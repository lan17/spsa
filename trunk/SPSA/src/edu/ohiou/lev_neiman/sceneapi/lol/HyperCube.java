...
import edu.ohiou.lev_neiman.sceneapi.basic.DisplayListManager;
...
{
    /**
     * size difference between parent and children.  its .5 by default, meaning each child is half the size of parent.
     */
    private float sf;
    ...
    public void makeRCubez( ANode tree, int n, int rec )
    {
        ...
        {
            return;
        } // if current recursion level is deeper than n, return.
        int nrec = rec + 1;
